...
from scrub.models import FunctionInfo, HygieneReport
...
from scrub.tools.parser import extract_classes, extract_functions, extract_module_info
from scrub.tools.rewriter import (
    apply_class_docstrings,
    apply_docstrings,
    apply_module_docstring,
    apply_type_annotations,
)
from scrub.utils import (
    batch,
