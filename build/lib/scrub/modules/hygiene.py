...
from scrub.config import CommentConfig
...
from scrub.modules.signatures import (
...
class BatchDocstringGenerator(dspy.Module):
    ...
    def __init__(self) -> None:
        super().__init__()
        from scrub.modules.signatures import BatchDocstringSignature
...
class BatchTypeAnnotator(dspy.Module):
    ...
    def __init__(self) -> None:
        super().__init__()
        from scrub.modules.signatures import BatchTypeAnnotationSignature
